...
* <code>DOMBuilder(tag, attributes)</code>
** <code>tag</code>: (String) The HTML tag to generate.
** <code>attributes</code>: (Hash) A JSON hash (associative array) containing the attributes to apply to the HTML tag.
